...
from misc.helpers import int_shape, log_sum_exp
...
def estimate_kld(x, y):
    ...
    l2_norm_xy = tf.sqrt(tf.reduce_sum((x_tile - y_tile)**2, axis=-1))
    l2_norm_xx = tf.sqrt(tf.reduce_sum((x_tile_0 - x_tile_1)**2, axis=-1))
